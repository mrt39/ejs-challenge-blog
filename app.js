...
app.get("/posts/:postTitle", function(req, res){
  ...
  for (let i = 0; i < posts.length; i++) {
    //store each of the title we have in our "posts" string in a variable
    const storedPostTitle = posts[i].title
    //store what's written as a parameter in URL (what's written as postTitle in /posts/:postTitle) as a variable
